...
<form class="layui-form layui-form-pane1" action="" lay-filter="first">
     <div class="layui-form-item" pane>
        ...
        <div class="layui-input-block">
            <input type="radio" name="member_type" value="0" title="微信用户" checked>
            <input type="radio" name="member_type" value="1" title="支付宝用户">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">openid *</label>
        <div class="layui-input-block">
            <input type="text" name="openid" lay-verify="required|openid" lay-reqText="openid不能为空" required
                   placeholder="请输入openid" autocomplete="off" class="layui-input"  value="">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="nickname" lay-verify="required|nickname" lay-reqText="昵称不能为空" required
                   placeholder="请输入昵称" autocomplete="off" class="layui-input"  value="">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <div class="layui-upload">
                ...
                <div class="layui-upload-list">
                    <img class="layui-upload-img" src="/admin/images/avatar.png" id="demo1">
                    <p id="demoText"></p>
                </div>
    ...
    <div class="layui-form-item" pane>
        ...
        <div class="layui-input-block">
            <input type="checkbox" name="status" lay-skin="switch" value="1" lay-text="正常|禁用"  checked >
        </div>
    </div>
        ...
        form.on('submit(saveBtn)', function (data) {
            ...
            $.ajax({
                ...
                success : function(data) {
                    ...
                    if (data.code == 0) {
                        setTimeout(function(){
                            var index = parent.layer.getFrameIndex('member_add');
