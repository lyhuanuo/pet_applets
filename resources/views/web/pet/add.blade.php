...
<form class="layui-form layui-form-pane1" action="" lay-filter="first" id="formdata" enctype="multipart/form-data">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <select name="code_id" lay-filter="interest-search" lay-search lay-verify="required|code_id">
                <option value="0">选择绑定二维码</option>
                @foreach ($codeList as $k => $v)
                    <option value="{{$v['id']}}">{{$v['code_number']}}</option>
                @endforeach
    ...
    <div class="layui-form-item" pane>
        <label class="layui-form-label">关联宠物</label>
        <div class="layui-input-inline" style="width:50%">
            <select name="relation" lay-filter="relation" lay-search lay-verify="relation">
                <option value="0">选择要关联的宠物</option>
        ...
        <div class="layui-form-mid" style="color:red">注：选择关联后无需填写以下所有信息</div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">宠物名称</label>
        <div class="layui-input-block">
            <input type="text" name="name" lay-verify="name" lay-reqText="宠物名称不能为空"
                   placeholder="请输入宠物名称" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">宠物品种</label>
        <div class="layui-input-block">
            <input type="text" name="type" lay-verify="type" lay-reqText="宠物品种不能为空"
                   placeholder="请输入宠物品种" autocomplete="off" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
                <select name="member_id" lay-filter="member_id" lay-search lay-verify="member_id">
                <option value="0">选择所属会户</option>
    ...
    <div class="layui-form-item" pane>
        ...
        <div class="layui-input-block">
            <input type="radio" name="sex" value="1" title="GG" checked>
            <input type="radio" name="sex" value="2" title="MM">
        </div>
    </div>
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <textarea placeholder="请输入返家寄语" class="layui-textarea" name="remark"></textarea>
        </div>
    </div>
        ...
        form.on('submit(saveBtn)', function (data) {
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    if (data.code == 0) {
                        setTimeout(function(){
                            var index = parent.layer.getFrameIndex('pet_add');
