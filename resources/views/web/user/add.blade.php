...
<form class="layui-form layui-form-pane1" action="" lay-filter="first">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="password" name="password" lay-verify="required|password"  autocomplete="off" required
                   class="layui-input" lay-reqText="密码不能为空" placeholder="请输入密码">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <div class="layui-upload">
                ...
                <div class="layui-upload-list">
                    <img class="layui-upload-img" src="/admin/images/logo.png" id="demo1">
                    <p id="demoText"></p>
                </div>
