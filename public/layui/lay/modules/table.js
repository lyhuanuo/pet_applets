                ...
                case"LAYTABLE_EXPORT":
                    r.ie ? l.tips("导出功能不支持 IE，请用 Chrome 等高级浏览器导出", this, {tips: 3}) : s({
                        list: function () {
                            ...
                            return ['<li class="exportSelected" data-type="xls">导出到选中数据到Excel 文件</li>', '<li class="exportAll" data-type="xls">导出到当页数据到 Excel 文件</li>'].join("")
                        }(), done: function (e, l) {
                            ...
                            l.on('click',function(){
                                ...
                                if(choise == 'exportSelected'){
                                    if(checkStatus.data.length < 1){
                                        ...
                                        d.exportFile.call(i, a.id, checkStatus.data, e)
                                    }
                                }else{
                                    d.exportFile.call(i, a.id, null, e)
                                }
